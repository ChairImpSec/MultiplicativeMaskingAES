...
module and_dom_indep_d2_0 ( clk, x, y, r, z );
  ...
  Register_N1_0 D1 ( .in(AND1), .clk(clk), .out(DFFout[1]) );
...
module and_dom_indep_d2_1 ( clk, x, y, r, z );
  ...
  AND2_X1 U2 ( .A1(x[1]), .A2(y[1]), .ZN(AND5) );
  AND2_X1 U3 ( .A1(x[0]), .A2(y[0]), .ZN(AND1) );
  NAND2_X1 U4 ( .A1(y[2]), .A2(x[1]), .ZN(n19) );
  XNOR2_X1 U5 ( .A(n19), .B(r[2]), .ZN(r2XORAND6) );
  NAND2_X1 U6 ( .A1(y[1]), .A2(x[2]), .ZN(n20) );
  XNOR2_X1 U7 ( .A(n20), .B(r[2]), .ZN(r2XORAND8) );
  NAND2_X1 U8 ( .A1(x[0]), .A2(y[1]), .ZN(n21) );
  XNOR2_X1 U9 ( .A(n21), .B(r[0]), .ZN(r0XORAND2) );
  NAND2_X1 U10 ( .A1(x[0]), .A2(y[2]), .ZN(n22) );
  XNOR2_X1 U11 ( .A(n22), .B(r[1]), .ZN(r1XORAND3) );
  NAND2_X1 U12 ( .A1(y[0]), .A2(x[1]), .ZN(n23) );
  XNOR2_X1 U13 ( .A(n23), .B(r[0]), .ZN(r0XORAND4) );
  NAND2_X1 U14 ( .A1(y[0]), .A2(x[2]), .ZN(n24) );
  XNOR2_X1 U15 ( .A(n24), .B(r[1]), .ZN(r1XORAND7) );
...
module circuit ( clk, shared_inp, PRNG, out );
  ...
  and_dom_indep_d2_3 G5 ( .clk(clk), .x(w1), .y(w2), .r(PRNG[14:12]), .z(w5)
         );
  and_dom_indep_d2_2 G6 ( .clk(clk), .x(w3), .y(w4), .r(PRNG[17:15]), .z(w6)
         );
  and_dom_indep_d2_1 G7 ( .clk(clk), .x(w5), .y(w6), .r(PRNG[20:18]), .z(out)
         );
  INV_X1 U16 ( .A(shared_inp[16]), .ZN(n16) );
  INV_X1 U15 ( .A(shared_inp[17]), .ZN(n15) );
  INV_X1 U14 ( .A(shared_inp[18]), .ZN(n14) );
  INV_X1 U13 ( .A(shared_inp[19]), .ZN(n13) );
  INV_X1 U12 ( .A(shared_inp[20]), .ZN(n12) );
  INV_X1 U11 ( .A(shared_inp[21]), .ZN(n11) );
  INV_X1 U10 ( .A(shared_inp[22]), .ZN(n10) );
  INV_X1 U9 ( .A(shared_inp[23]), .ZN(n9) );
endmodule
